    ...
    <div>
      <footer class="px-4 divide-y bg-coolGray-100 text-coolGray-800">
        <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div class="lg:w-1/3">
            <a href="#" class="flex justify-center space-x-3 lg:justify-start">
              ...
              <div className="footer-left">
                <span class="self-center text-2xl font-semibold">Movie</span>

                <div class="space-y-3">
                  <div class="uppercase text-coolGray-900 w-3/5">
          ...
          <div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4 footer-item">
            <div class="space-y-3">
              <h3 class="tracking-wide uppercase text-coolGray-900">
                Cybersoft Movie
              </h3>
              <ul class="space-y-1">
                <li>
            ...
            <div class="space-y-3">
              <h3 class="tracking-wide uppercase text-coolGray-900">Browse</h3>
              <ul class="space-y-1">
                <li>
                  <a href="#">Live TV</a>
                </li>
            ...
            <div class="space-y-3">
              <h3 class="uppercase footer-nav">asd</h3>
              <ul class="space-y-1">
                <li>
                  <a href="#">TV Shows</a>
                </li>
            ...
            <div class="space-y-3">
              <h3 class="uppercase text-coolGray-900">Help</h3>
              <ul class="space-y-1">
                <li>
        ...
        <div class="py-6 text-sm text-center text-coolGray-600 ">
