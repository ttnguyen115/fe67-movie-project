...
const adminMovieReducer = (state = adminMovieInitialState, { type, payload }) => {
    switch (type) {
        ...
        case adminTypes.ADMIN_DELETE_MOVIE_REQUEST:
            state.loading = true;
            return { ...state };
        case adminTypes.ADMIN_DELETE_MOVIE_SUCCESS:
            state.loading = false;
            state.error = null;
            state.notify = payload;
            return { ...state };
        case adminTypes.ADMIN_DELETE_MOVIE_FAILURE:
            state.loading = false;
            state.error = payload;
            return { ...state };
